...
plot 'nrmData.txt' using 1:($3/$2) with linespoints lw 4 pi -1 ps 1.5 lc rgb '#FF9933' title 'N=128';
replot 'nrmData.txt' using 1:($5/$4) with linespoints lw 4 pi -1 pt 9 ps 1.5 lc rgb '#FF5050' title 'N=256';
replot 'nrmData.txt' using 1:($7/$6) with linespoints pi -1 pt 5 ps 1.5 lw 4 lc rgb '#6600FF' title 'N=512';
replot 'nrmData.txt' using 1:($9/$8) with linespoints pt 7 pi -1 ps 1.5 lw 4 lc rgb '#0066FF' title 'N=1024';
